!(function (e, t) {
    ...
    function r() {
        ...
        return (
            ...
            (e.mark = function (e) {
                return (
                    Object.setPrototypeOf ? Object.setPrototypeOf(e, p) : ((e.__proto__ = p), u(e, s, "GeneratorFunction")),
            ...
            (R.prototype = {
                ...
                delegateYield: function (e, t, r) {
                    return (this.delegate = { iterator: A(e), resultName: t, nextLoc: r }), "next" === this.method && (this.arg = void 0), l;
                },
            }),
            e
        );
    ...
    function U(e, t) {
        var r,
            ...
            s = void 0 !== a && a;
        if (null != e)
            if (("object" !== n(e) && (e = [e]), S(e))) for (r = 0, o = e.length; r < o; r++) t.call(null, e[r], r, e);
            else {
                var u,
            ...
            isFormData: function (e) {
                ...
                return (
                    ...
                    (("function" == typeof FormData && e instanceof FormData) ||
                        (x(e.append) && ("formdata" === (t = w(e)) || ("object" === t && x(e.toString) && "[object FormData]" === e.toString()))))
                );
            },
                ...
                if (!$.isUndefined(r)) {
                    ...
                    l.push(r),
                        $.forEach(r, function (r, o) {
                            !0 === (!($.isUndefined(r) || null === r) && i.call(t, r, $.isString(o) ? o.trim() : o, n, h)) &&
                                e(r, n ? n.concat(o) : [o]);
                        }),
                        l.pop();
                }
    ...
    var fe,
        ...
        me = t(t({}, Object.freeze({ __proto__: null, hasBrowserEnv: pe, hasStandardBrowserWebWorkerEnv: ye, hasStandardBrowserEnv: ve })), de);
    function ge(e) {
        function t(e, r, n, o) {
            var i = e[o++];
    ...
    function Ae(e, t, r, n, o) {
        return $.isFunction(n)
            ? n.call(this, t, r)
            : (o && (t = r), $.isString(t) ? ($.isString(n) ? -1 !== t.indexOf(n) : $.isRegExp(n) ? n.test(t) : void 0) : void 0);
    }
    var je = (function (e, t) {
        function r(e) {
            ...
            if (!r) {
                ...
                throw new Q(
                    "There is no suitable adapter to dispatch the request " +
                        (n ? (s.length > 1 ? "since :\n" + s.map(Ue).join("\n") : " " + Ue(s[0])) : "as no adapter specified"),
                    "ERR_NOT_SUPPORT"
                );
            }
            return r;
    ...
    Je.transitional = function (e, t, r) {
        ...
        return function (r, o, i) {
            ...
            return (
                t && !Ge[o] && ((Ge[o] = !0), console.warn(n(o, " has been deprecated since v" + t + " and will be removed in the near future"))),
                !e || e(r, o, i)
            );
        };
    };
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            if (!u) {
                                ...
                                for (d.unshift.apply(d, s), d.push.apply(d, f), l = d.length, c = Promise.resolve(t); h < l; )
                                    c = c.then(d[h++], d[h++]);
                                return c;
                            }
                            l = s.length;
        ...
        $.forEach(["post", "put", "patch"], function (e) {
            function t(t) {
                return function (r, n, o) {
                    return this.request(Me(o || {}, { method: e, headers: t ? { "Content-Type": "multipart/form-data" } : {}, url: r, data: n }));
                };
            }
